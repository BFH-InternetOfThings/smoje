...
class AlertTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.AlertTableMap';
     ...
     */
    const COL_ID = 'alert.id';

    /**
     * the column name for the message field
     */
    const COL_MESSAGE = 'alert.message';

    /**
     * the column name for the timestamp field
     */
    const COL_TIMESTAMP = 'alert.timestamp';

    /**
     * the column name for the sensorstation_id field
     */
    const COL_SENSORSTATION_ID = 'alert.sensorstation_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Message', 'Timestamp', 'SensorstationId', ),
        self::TYPE_CAMELNAME     => array('id', 'message', 'timestamp', 'sensorstationId', ),
        self::TYPE_COLNAME       => array(AlertTableMap::COL_ID, AlertTableMap::COL_MESSAGE, AlertTableMap::COL_TIMESTAMP, AlertTableMap::COL_SENSORSTATION_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'message', 'timestamp', 'sensorstation_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Message' => 1, 'Timestamp' => 2, 'SensorstationId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'message' => 1, 'timestamp' => 2, 'sensorstationId' => 3, ),
        self::TYPE_COLNAME       => array(AlertTableMap::COL_ID => 0, AlertTableMap::COL_MESSAGE => 1, AlertTableMap::COL_TIMESTAMP => 2, AlertTableMap::COL_SENSORSTATION_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'message' => 1, 'timestamp' => 2, 'sensorstation_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('message', 'Message', 'VARCHAR', true, 255, '');
        $this->addColumn('timestamp', 'Timestamp', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
        $this->addForeignKey('sensorstation_id', 'SensorstationId', 'INTEGER', 'sensorstation', 'id', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Sensorstation', '\\Sensorstation', RelationMap::MANY_TO_ONE, array('sensorstation_id' => 'id', ), null, null);
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AlertTableMap::COL_ID);
            $criteria->addSelectColumn(AlertTableMap::COL_MESSAGE);
            $criteria->addSelectColumn(AlertTableMap::COL_TIMESTAMP);
            $criteria->addSelectColumn(AlertTableMap::COL_SENSORSTATION_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.message');
            $criteria->addSelectColumn($alias . '.timestamp');
            $criteria->addSelectColumn($alias . '.sensorstation_id');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(AlertTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(AlertTableMap::COL_ID) && $criteria->keyContainsValue(AlertTableMap::COL_ID) ) {
